...
export default {
  ...
  setup(props) {
    const itemChoice = [
      {
        src: new URL("@/assets/slide/IMG_4732.jpg", import.meta.url).href,
      },
      {
  ...
  data() {
    return {
      ...
      audioFile: [
        {
          src: new URL("@/public/audio1/audio13.m4a", import.meta.url).href,
        },
        {
          src: new URL("@/public/audio1/audio14.m4a", import.meta.url).href,
        },
        {
          src: new URL("@/public/audio1/audio17.m4a", import.meta.url).href,
        },
      ],
  ...
  methods: {
    ...
    // nextWay2() {
    //   this.itemChoice = this.itemChoice1;
    //   this.indexItem += 1;
    // },
    nextWay3() {},
